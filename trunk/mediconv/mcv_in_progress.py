...
from mcv_info import app_name
from mcv_util import timeremaining, hourminsec, confirm_overwrite, \
                        cancel_check
...
class ProgressWindow:
    def __init__(self, transcoder, infile, outfile):
        ...
        xmlpath= os.path.join(xmlpath, "mediconv.xml")
        ...
        self._window = self.builder.get_object("progress_window")
        self._progressbar = self.builder.get_object("progressbar")
        self._buttonbox = self.builder.get_object("buttonbox")
        self._pause_button = self.builder.get_object("pause_button")
        self._label = self.builder.get_object("convert_label")
